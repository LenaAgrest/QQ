...
using namespace QQ;
    ...
    void PostControl::InitializeComponent(void)
    {
        ...
        this->label1->Click += gcnew System::EventHandler(this, &PostControl::Label1_Click);
        ...
        this->tableLayoutPanel1->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Percent, 74.09579F)));
    ...
    void PostControl::Edit_Click(Object^ sender, EventArgs^ e)
    {
        ...
        this->text_post_t->Size = System::Drawing::Size(730, 100);
        ...
        this->save->Click += gcnew System::EventHandler(this, &PostControl::save_Click);
        ...
        this->otmena->Click += gcnew System::EventHandler(this, &PostControl::otmena_Click);
    ...
    void PostControl::Label1_Click(Object^ sender, EventArgs^ e)
    {
    ...
    void PostControl::otmena_Click(System::Object^ sender, System::EventArgs^ e) {
        this->tableLayoutPanel2->Controls->Remove(this->text_post_t);
        this->tableLayoutPanel2->Controls->Add(this->text_post);
        this->tableLayoutPanel2->Controls->Remove(this->title_post);
        this->tableLayoutPanel2->Controls->Add(this->title_post_l);  
